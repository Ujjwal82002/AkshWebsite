...
const Client = () => {
    ...
    return (
        <div className='p-10 mx-auto mt-5 overflow-hidden max-w-9xl'>
            ...
            <div className='mt-4 m-20 w-[70%] h-[300%] px-[-25px] lg:mt-10 lg:mx-64'>
                <Slider {...settings}>
                    <div className='bg-[#F1F4F8] rounded-[30px] p-6 h-full'>
