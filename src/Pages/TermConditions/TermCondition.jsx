  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-2">Terms and Conditions of Aksh Technology</h1>
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">Use of Services</h1>
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">User Conduct</h1>
        ...
        <ul className="list-disc list-inside text-gray-700">
          ...
          <li>
            Engaging in any activity that could harm or disrupt our services or
            the servers and networks that support our services.
          </li>
        </ul>
      </div>

      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">Intellectual Property</h1>
        <p className="text-gray-700">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">Disclaimers and Limitation of Liability</h1>
        <h3 className="text-xl font-medium mb-2">Disclaimers</h3>
        ...
        <p className="text-gray-700">
          ...
          our services. (ii) any unauthorized access to or use of our servers
          and/or any personal information stored therein (iii) any interruption
          or cessation of transmission to or from our services (iv) any bugs,
          viruses, or the like that may be transmitted to or through our
          services by any third party (v) any errors or omissions in any content
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">Governing Law</h1>
        <p className="text-gray-700">
      ...
      <div className="mb-8">
        <h1 className="text-2xl font-semibold mb-4">Changes to Terms</h1>
        <p className="text-gray-700">
