      ...
      <div className="flex flex-col items-center w-full max-w-5xl mt-8 md:mt-12 lg:mt-16">
        <div className="text-center">
          ...
          <p className="w-full mx-auto mt-2 text-sm sm:mt-4 sm:text-base md:text-lg sm:w-4/5 lg:w-3/4">
            Have any questions about Software Devlopment services? You can check the
        ...
        <div className="flex flex-col w-full h-auto mt-8 Accordian md:mt-12">
          {[
            { id: "para1", question: "How does a Software Devlopment project start?",ans:"A software development project starts with requirement gathering, where stakeholders define objectives, functionalities, and target users. This is followed by planning, designing system architecture, and creating a detailed development roadmap." },
