    ...
    <div className="flex items-center justify-center min-h-screen p-4 text-white">
      <div className="w-full max-w-6xl bg-[#000116] rounded-xl flex flex-col lg:flex-row justify-between items-center p-4 lg:p-10">
        <div className="flex flex-col items-center justify-center mt-10 lg:items-start lg:mt-0">
          ...
          App development is the process of designing, building, and maintaining applications for mobile or desktop platforms. It involves coding, testing, 
          and deploying software to create user-friendly and functional applications that meet specific needs.{" "}
            <br /> that align with technological advancements.
          </p>
          <button className="flex bg-[#FFFFFF] w-full lg:w-96 justify-between text-black items-center pl-4 text-lg font-bold rounded-lg mt-4 lg:mt-10"   onClick={openPopup}>
            Contact Us
