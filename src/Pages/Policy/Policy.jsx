  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-md rounded-lg p-8 max-w-4xl w-full mx-4">
        <h1 className="text-3xl font-bold mb-4 text-center">Privacy Policy of Aksh Technology</h1>
        <p className="text-gray-600 mb-2 text-center">Effective Date: May 30, 2024</p>
        ...
        <section className="mb-4">
          ...
          <h3 className="text-xl font-semibold mb-2 mt-4">Non-Personal Information</h3>
        ...
        <section className="mb-4">
          ...
          <p className="text-gray-700">Aksh Technology<br />
            ...
            Phone: 9625510038<br />
            Address: T-4, A-88, Sector 4, Noida, Uttar Pradesh, 201301</p>
        </section>
      </div>
    </div>
  );
