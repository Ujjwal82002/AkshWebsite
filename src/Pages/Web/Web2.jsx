...
export default function Web2() {
  return (
    <div className="px-4 overflow-hidden bg-[#00ffff] lg:mt-[-50px]  w-full sm:px-8 lg:px-[120px] py-8 lg:py-[140px]">
    <div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-10">
          <div className="text-center lg:text-left">
            <section className="p-4 lg:mt-[-150px] lg:px-6">
              ...
              <p className="text-base lg:ml-24 sm:text-lg md:text-xl lg:text-xl  lg:font-display font-display mt-4 lg:mt-[-30px] text-[rgb(0,0,0)]">
