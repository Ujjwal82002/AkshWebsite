...
export default function Web2() {
  ...
  return (
    <div className="px-4 overflow-hidden  lg:mt-[-100px] w-full sm:px-8 lg:px-[120px] py-8 lg:py-[140px]">
    <div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-10">
          <div className="text-center lg:text-left">
            <section className="p-4 lg:mt-[-150px] lg:px-6">
              ...
              <p className="text-base lg:ml-24 sm:text-lg md:text-xl lg:text-xl  lg:font-medium font-medium mt-4 lg:mt-[-30px] text-slate-700">
              
             
                      Web development encompasses the creation and management of websites and web applications.
              </p>
