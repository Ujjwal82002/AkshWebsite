...
export default function Web3()  {
  return (
    ...
    <div className="flex flex-col lg:mt-[-200px] mt-[-15px] m-8 lg:flex-row lg:m-32 lg:ml-48">
      <div className="w-full lg:w-[518px] mt-8 lg:m-[0] lg:h-[410.98px] mb-8 lg:mb-0">
