...
export default function Web3()  {
  return (
    <div  className="bg-[#00ffff] max-w-screen-2xl">
    <div className="flex flex-col lg:mt-[-200px] m-8 lg:flex-row lg:m-32 lg:ml-40">
      <div className=" lg:w-[518px] mt-7 lg:m-0 lg:h-[410.98px] mb-8 lg:mb-0">
        <h1 className="text-3xl font-display lg:text-5xl">
          Design. Think.
        </h1>
