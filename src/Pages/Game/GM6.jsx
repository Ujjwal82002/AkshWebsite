      ...
      <div className="flex flex-col items-center w-full max-w-5xl mt-8 md:mt-12 lg:mt-16">
        <div className="text-center">
          ...
          <p className="w-full mx-auto mt-2 text-sm sm:mt-4 sm:text-base md:text-lg sm:w-4/5 lg:w-3/4">
            Have any questions about Game Devlopment services? You can check the
        ...
        <div className="flex flex-col w-full h-auto mt-8 Accordian md:mt-12">
          {[
            { id: "para1", question: "How does a Game Devlopment project start?", ans:"A game development project starts with concept ideation, where developers outline the game’s vision, genre, and target audience. This is followed by planning, prototyping, and creating a detailed design document." },
