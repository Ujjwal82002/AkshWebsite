        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-10">
          <div className="text-center lg:text-left">
            <section className="p-4 lg:mt-[-150px] lg:px-6">
              ...
              <p className="text-base lg:ml-24 sm:text-lg md:text-xl lg:text-xl lg:font-medium font-serif mt-4 lg:mt-[-30px] text-slate-700">
              Game development offers numerous benefits, including fostering creativity and innovation by allowing developers to bring imaginative worlds to life.
              </p>
